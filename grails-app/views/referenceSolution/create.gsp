...
<div class="box" style="width: 950px;">
    <span style="font-size: 18px; font-weight: bold;">${problem.name}</span>
    <br/>
    <span style="font-size: 16px; font-weight: bold;"><g:message code="entity.language" />: ${language}</span>
    ...
    <g:form action="save" method="post" enctype="multipart/form-data">
        ...
        <div>
            <div style=" height: 16px;"><span style="font-size: 12px; display:none;" id="comment-text"><g:message code="reference.solution.comment" /></span>    <span style="float: right;"><img align="Absbottom" id="problem-status-icon" style="border: 0 none;" src="" /></span></div>
        </br>
